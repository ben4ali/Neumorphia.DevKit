...
export const TokenReferenceTable: React.FC<TokenReferenceTableProps> = ({ tokens }) => {
  ...
  return (
    <div className="rounded-neo-card bg-neo-surface shadow-neo-raised-md border border-neo-border overflow-hidden text-left space-y-3 p-5">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-xs border-collapse">
          <thead>
            <tr className="border-b border-neo-border/60 text-neo-primary/60">
          ...
          <tbody className="divide-y divide-neo-border/40">
            {tokens.map((token) => (
